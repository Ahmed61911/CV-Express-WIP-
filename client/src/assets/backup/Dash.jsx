import CvCard from "../../pages/components/CvCard"

const Dash = () => {
  return (
    <>
        <aside class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white  dark:bg-slate-300 transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
            <div>
                ...
                <ul class="space-y-2 tracking-wide mt-8">
                    ...
                    <li>
                        <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                <path class="fill-current text-gray-300 group-hover:text-cyan-300 dark:text-gray-400" fill-rule="evenodd" d="M2 6a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1H8a3 3 0 00-3 3v1.5a1.5 1.5 0 01-3 0V6z" clip-rule="evenodd" />
                    ...
                    <li>
                        <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <path class="fill-current text-gray-300 group-hover:text-cyan-300 dark:text-gray-400" d="M15 7h1a2 2 0 012 2v5.5a1.5 1.5 0 01-3 0V7z" />
                            </svg>
                    ...
                    <li>
                        <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <path class="fill-current text-gray-300 group-hover:text-cyan-300 dark:text-gray-400" d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" />
                            </svg>
                    ...
                    <li>
                        <a href="#" class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                <path class="fill-current text-gray-300 group-hover:text-cyan-300 dark:text-gray-400" d="M4 4a2 2 0 00-2 2v1h16V6a2 2 0 00-2-2H4z" />
        ...
        <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%] bg-slate-200 dark:bg-slate-500">
            ...
            <div class="flex space-x-8 px-6 pt-6 2xl:container h-[100vh] min-w-full min-h-full">
                <div class="cards">
                    <CvCard />
                    <CvCard />
                    <CvCard Type="add" />
