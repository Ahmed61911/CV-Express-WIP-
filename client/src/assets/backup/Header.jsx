...
const Header = () => {
  return (
    <>
        <SignedOut>
            <header className="w-full mt-0 text-gray-700 bg-white border-t border-gray-100 shadow-sm body-font">
                <div className="container flex justify-between p-4 mx-auto md:flex-row items-center">
                    <a className="flex items-center mb-4 font-medium text-gray-900 title-font md:mb-0">
                        <img src={HeaderLogo} alt="logo" width={120} />
                    </a>
                    <nav className="flex flex-wrap items-center justify-center pl-6 ml-6 text-base border-l border-gray-200 md:mr-auto max max-lg:hidden">
                    ...
                    <div className="items-center h-full">
                        <SignInButton mode="modal" className="mr-5 font-medium hover:text-gray-900"></SignInButton>
                        <SignUpButton mode="modal" href="#_"
                    ...
                    <div className=" ml-12 hidden max-lg:block max-lg:ml-0">
                        <img src={Hamburger} alt="dropdownlist" width={25}/>
                    </div>
                </div>
            </header>
        </SignedOut>
