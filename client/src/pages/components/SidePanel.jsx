const SidePanel = () => {
  return (
    <>
        <div className="fixed top-0 left-0 flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 h-[calc(100vh-0.5rem)] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5 my-1 mx-1 dark:bg-gray-800">
            <div className="mb-2 p-4">
                <h5 className="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-gray-900 dark:text-white">Material Tailwind</h5>
            </div>
            <nav className="flex flex-col gap-1 min-w-[240px] p-2 font-sans text-base font-normal text-gray-700 dark:text-gray-100">
                ...
                <div className="grid place-items-center mr-4">
                    ...
                    <div className="relative grid items-center font-sans font-bold uppercase whitespace-nowrap select-none bg-blue-500/20 text-blue-900 dark:text-blue-400 py-1 px-2 text-xs rounded-full">
