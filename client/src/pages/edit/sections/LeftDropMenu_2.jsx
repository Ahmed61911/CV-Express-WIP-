                ...
                <div class="w-full px-4">
                    ...
                    <div class="relative w-full mb-3">
                        ...
                        <textarea 
                            ...
                            onChange={(e) => handleChange(field.id, "value", e.target.value)}
                            placeholder={field.label || "Enter text"}
                            class="border-0 px-3 py-3 w-full placeholder-gray-300 text-gray-600 bg-blue-50 rounded text-sm shadow focus:outline-none focus:ring max-w-[40vw] min-w-[20vw] ease-linear transition-all duration-150" rows="4"> A beautiful UI Kit and Admin for JavaScript &amp; Tailwind CSS. It is Freeand Open Source.</textarea>
                    </div> 
                ...
                <div className="form-fields">
                    ...
                    <div key={field.id} className="field">
                        <div class="flex flex-row place-content-between">
                            ...
                            <h1 className="text-lg text-gray-700 font-semibold">Experience {ExpCount}:</h1>
