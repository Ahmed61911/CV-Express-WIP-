const Main = () => {
    return (
      <div className='bg-blue-100 p-[4rem] '>
        <div class="grid sm:grid-cols-2 items-start gap-16 p-16 mx-auto max-w-4xl font-[sans-serif] bg-indigo-300 shadow-slate-600 shadow-2xl">
            <div>
            ...
            <form class="ml-auto space-y-4">
                <input type='text' placeholder='Name'
                    class="w-full rounded-md py-3 px-4 dark:bg-gray-300 text-gray-800 text-sm outline-blue-500 focus:bg-transparent" />
                <input type='email' placeholder='Email'
                    class="w-full rounded-md py-3 px-4 dark:bg-gray-300 text-gray-800 text-sm outline-blue-500 focus:bg-transparent" />
                <input type='text' placeholder='Subject'
                    class="w-full rounded-md py-3 px-4 dark:bg-gray-300 text-gray-800 text-sm outline-blue-500 focus:bg-transparent" />
                <textarea placeholder='Message' rows="6"
                    class="w-full rounded-md px-4 dark:bg-gray-300 text-gray-800 text-sm pt-3 outline-blue-500 focus:bg-transparent"></textarea>
                <button type='button'
